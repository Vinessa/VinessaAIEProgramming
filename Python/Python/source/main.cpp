...
namespace AIE
{
	...
	void Load( PyObject* a_pModule )
	{
		...
		int fv2Size[2] = {64.0f, 64.0f};
		int fv2Origin[2] = {0.5f, 0.5f};
		float fv4UVCoords[4] = { 0.f, 0.f, 1.f, 1.f }; // min and max uv coordinates.
		float vColour[4] = { 1.f, 1.f, 1.f, 1.f }; // color is white

		unsigned int uiSpriteID = AIE_CreateSprite( "./images/crate_sideup.png", fv2Size, fv2Origin, fv4UVCoords, SColour(vColour[0]/255, vColour[1]/255, vColour[2]/255, vColour[3]/255) );
