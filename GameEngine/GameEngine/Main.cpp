...
//glBufferData (GL_ARRAY_BUFFER, 18 * sizeof (float), pointsH, GL_STATIC_DRAW);
//GLuint VAOH = 0;
//glGenVertexArrays (1, &VAOH);
//glBindVertexArray (VAOH);
//glEnableVertexAttribArray (0);
//glBindBuffer (GL_ARRAY_BUFFER, VBOH);
//glVertexAttribPointer (0,5,GL_FLOAT, GL_FALSE, 0, (GLubyte*) NULL);
//
//
//const char* vertex_shaderH = 
//	"#version 400\n"
//	"in vec3 vp;"
//	"void main() {"
//	" gl_Position = vec4 (vp, 1.0);"
//	"}";
//
//const char* fragment_shaderH = 
//	"#version 400\n"
//	"out vec4 frag_colour;"
//	"void main () {"
//	" frag_colour = vec4 (0.0, 166.0, 147.0, 1.0);"
//	"}";
//
// Create a Shader
//	GLuint vsH = glCreateShader (GL_VERTEX_SHADER);
//	put the actual char* into the shader
//	glShaderSource (vsH, 1, &vertex_shader2, NULL);
//	Compile the shader
//	glCompileShader (vsH);
//	GLint fsH = glCreateShader (GL_FRAGMENT_SHADER);
//	glShaderSource (fsH, 1, &fragment_shaderH, NULL);
//	glCompileShader (fsH);
//	Create the conrtainer that holds your shaders
//	GLuint shaderProgramH = glCreateProgram();
//	attach the shaders you compiled
//	glAttachShader(shaderProgramH, fsH);
//	glAttachShader(shaderProgramH, vsH);
//	this is links the shaders together, it's kinds like a compile
