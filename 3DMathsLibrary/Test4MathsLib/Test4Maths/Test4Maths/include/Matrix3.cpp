...
bool Matrix3::operator == (Matrix3& a_Mat1)
{
	Threshold = .0005;
	if (((m_A1 - a_Mat1.m_A1) < Threshold) && ((m_A2 - a_Mat1.m_A2) < Threshold) && ((m_A3 - a_Mat1.m_A3) < Threshold) &&
		((m_B1 - a_Mat1.m_B1) < Threshold) && ((m_B2 - a_Mat1.m_B2) < Threshold) && ((m_B3 - a_Mat1.m_B3) < Threshold) &&
		((m_C1 - a_Mat1.m_C1) < Threshold) && ((m_C2 - a_Mat1.m_C2) < Threshold) && ((m_C3 - a_Mat1.m_C3) < Threshold))
		return true;
	else
		return false;
