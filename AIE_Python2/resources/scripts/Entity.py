...
class TankEntity:
	...
	def update(self, fDeltaTime ):
		...
		AIE.MoveSprite( self.spriteID, self.Position.x, self.Position.y )
...
class Turret:
	...
	def update(self, fDeltaTime):
		...
		AIE.MoveSprite( self.spriteID, turretLocation.x, turretLocation.y )
